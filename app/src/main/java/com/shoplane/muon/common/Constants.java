...
public final class Constants {
    ...
    public static final String SHARED_PREF_USERID = "userloginid";
    public static final String SHARED_PREF_LOGIN_MODE = "loginmode";
    public static final String SHARED_PREF_LOGIN_ACCESS_TOKEN = "loginaccesstoken";
    public static final String SHARED_PREF_LOGIN_AUTH_TOKEN = "loginauthtoken";
